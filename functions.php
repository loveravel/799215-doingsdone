<?php
/**
 * Подключает шаблоны страниц на основе имени шаблона и передаваемых в него данных
 *
...
/**
 * Обрабатывает запрос к Базе Данных на основе SQL запроса
 *
...
/**
 * Вычисляет количество задач в проекте на основе списка задач и идентификатора проекта
 *
...
/**
 * Проверяет важность задачи (задача считается важной, если на ее выполнение осталось менее 24 часов) на основе даты дедлайна
 *
...
/**
 * Выполняет валидацию даты, введеной пользователем, в поле 'deadline'
 *
...
/**
 * Выполняет проверку обязательных полей формы на заполненность на основе данных, полученных из массива $_POST,
 * и массива, содержащего обязательные поля
 *
 * @param array $info_list Массив значений $_POST
...
/**
 * Выполняет валидацию формы для добавления задач в проект на основе данных, полученных из массива $_POST,
 * массива, содержащего обязательные поля и массива, содержащего существующие проекты
 *
 * @param array $info_list Массив значений $_POST
 * @param array $required_fields Массив содержащий список обязательных для заполнения полей
...
/**
 * Выполняет валидацию формы для регистрации пользователя на основе начличия соединения с Базой Данных,
 * данных, полученных из массива $_POST, и массива, содержащего обязательные поля
 *
 * @param mysqli $link Соединение с БД
 * @param array $info_list Массив значений $_POST
 * @param array $required_fields Массив содержащий список обязательных для заполнения полей
...
/**
 * Выполняет валидацию формы для аутентификации пользователя на основе начличия соединения с Базой Данных,
 * данных, полученных из массива $_POST, и массива, содержащего обязательные поля
 *
 * @param mysqli $link Соединение с БД
 * @param array $info_list Массив значений $_POST
...
/**
 * Выполняет обновление статуса задачи на основе наличия соединения с Базой Данных и
 * данных, полученных из массива $_GET
 *
 * @param mysqli $link Соединение с БД
...
/**
 * Выполняет полнотекстовый поиск задач на основе наличия соединения с Базой Данных и
 * данных, полученных из массива $_POST
 *
 * @param mysqli $link Соединение с БД
